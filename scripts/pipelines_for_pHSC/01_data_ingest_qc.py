...
subdirectories = [
    ...
    'HSC_11_FL189/outs/filtered_feature_bc_matrix/',
    'HSC_11_FBM189/outs/filtered_feature_bc_matrix/',
...
adata = adatas[0].concatenate(adatas[1:], batch_categories = [
        ...
        'HSC_HSC_11_E93M_FL_HT_CY189',
        'HSC_HSC_11_E93M_BM_HT_CY189',
...
## save
adata.write('./anndataobjs/Mf.HSC.combined.pre-preprocessed.h5ad')
