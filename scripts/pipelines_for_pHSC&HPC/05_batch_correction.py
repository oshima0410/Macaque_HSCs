...
## data import
adata = sc.read_h5ad('./anndataobjs/Mf.HSPC.combined.preprocessed.h5ad')
...
## save
model.save("my_model_240104/")
adata.write('./anndataobjs/Mf.HSPC.scVI.combined.processed.h5ad')
